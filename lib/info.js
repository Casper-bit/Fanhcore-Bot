exports.info = (id, FANHCORE BOT, corohelp, tampilTanggal, tampilWaktu, fanhcore__2542, -, -, Ntah, https://chat.whatsapp.com/GnLdLnx9zx69Ypx1Hqyu6r) => {
	return `🐦 ${BotName} 🐦
...
INFO BOT! :
🔱 *AUTHOR*: Fani Kun from REUZ
🔱 *GITHUB*: https://github.com/Casper-bit/Fanhcore-Bot
🔱 *INSTAGRAM*: ${fanhcore__2542}
🔱 *YOUTUBE*: ${-}
🔱 *TELEGRAM* : ${-}
🔱 *WHATSAPP* : 0821-3220-9625
